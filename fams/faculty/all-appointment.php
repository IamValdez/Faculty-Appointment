		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="widget">
					...
					<header class="widget-header">	<div class="col-lg-3 col-10">
                            <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search Appointments...">
                        </div>
