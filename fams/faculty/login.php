...
<style>
      ...
      align-items: center;
      background: linear-gradient(to bottom, #5b69bc, #ffffff); /* Violet to white gradient */
...
<body>
    ...
    <div class="simple-page-wrap">
        ...
        <span style="color: white"><i class=""><img src="/images/title/logo.jpg" alt=""></i></span>
    ...
    <form method="post" name="login">
        ...
        <input type="submit" class="btn btn-purple" name="login" value="Sign In" id="signin-btn">
    </form>
    <br>
